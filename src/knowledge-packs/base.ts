...
export interface VerticalPack {
    ...
    trustSignals: string[];
    localProofPatterns: string[];
}

const inheritedDefault = (defaultPack || {}) as Partial<VerticalPack>;
...
const pack = (overrides: Partial<VerticalPack>): VerticalPack => ({
...
const ALIAS_TO_PACK: Record<string, string> = {
...
export function resolveVerticalPack(niche: string): VerticalPack {
    const raw = niche || '';
