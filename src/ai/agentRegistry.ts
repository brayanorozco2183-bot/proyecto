...
const registryEntries: AgentRoutingProfile[] = [
  ...
  { agentName: 'Niche_Coherence_Auditor', preferredTier: 'premium', fallbackTier: 'standard', capability: 'critic', promptFolder: 'Niche_Coherence_Auditor', learnFromFailures: true, notes: 'Cross-niche and semantic coherence.' },
  ...
  { agentName: 'Quality_Auditor_10', preferredTier: 'premium', fallbackTier: 'standard', capability: 'critic', promptFolder: 'Quality_Auditor_10', learnFromFailures: true, notes: 'QA scoring and issue summary.' },
