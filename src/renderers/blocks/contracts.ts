...
import { getProductionSafeVariant, isProductionSafeModeEnabled } from '../../config/productionSafeMode.js';
...
export function normalizeBlockRendererInput(input: BlockRendererInput): BlockRendererInput {
  ...
  const normalized: BlockRendererInput = {
    ...safeInput,
    variant: isProductionSafeModeEnabled()
      ? getProductionSafeVariant(safeInput.blockType, safeInput.variant)
      : safeInput.variant,
