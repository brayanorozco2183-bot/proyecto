...
export const COMPARISONTABLEVARIANTS = ['matrix_clean', 'matrix_bold'] as const;
export type ComparisonTableVariant = typeof COMPARISONTABLEVARIANTS[number];
...
export type ComparisonTablePayload = z.infer<typeof ComparisonTablePayloadSchema>;