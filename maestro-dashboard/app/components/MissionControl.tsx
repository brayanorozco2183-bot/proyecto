                ...
                <div style={{ padding: '0.5rem', borderTop: '1px solid var(--border)', paddingTop: '1rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', marginBottom: '1rem' }}>
                        <input
                            ...
                            placeholder="Nicho (Ej: Dentistas, Reformas, Abogados)"
                            style={{ padding: '0.5rem', background: '#050507', border: '1px solid var(--border)', borderRadius: '4px', color: '#fff', fontSize: '0.75rem' }}
                        />
                        <input
                            type="text"
                            value={locations}
                            onChange={(e) => setLocations(e.target.value)}
                            placeholder="Ciudades (Ej: Bilbao, Madrid, Sevilla)"
                            style={{ padding: '0.5rem', background: '#050507', border: '1px solid var(--border)', borderRadius: '4px', color: '#fff', fontSize: '0.75rem' }}
                        />
                    </div>
