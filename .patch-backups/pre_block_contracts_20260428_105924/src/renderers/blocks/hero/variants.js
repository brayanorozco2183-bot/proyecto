import { escapeHtml, renderCta, renderInlinePills, wrapHeroBlock } from '../shared.js';
function resolvePhone(input) {
...
export const renderHeroVariants = {
