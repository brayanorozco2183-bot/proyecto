...
7. **REGLA DE PROHIBICIÓN (CRÍTICA)**: Queda TERMINANTEMENTE PROHIBIDO usar los siguientes conceptos o claims: ${input.sectionBrief?.prohibitedClaims?.join(', ') || 'Sin tiempos record ni precios cerrados por teléfono.'}. Su uso causará el rechazo total de la página. Escribe contenido honesto, técnico y realista.
